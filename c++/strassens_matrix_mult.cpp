...
void matrix_mul(int **a, int **b, int **c, int n)
{
	...
	else
	{
		...
		//calculation of m1 to m7
		matrix_sum(a11, a22, temp1, (n / 2));  // temp1 = a11 + a22
		matrix_sum(b11, b22, temp2, (n / 2));  // temp2 = b11 + b22
		matrix_mul(temp1, temp2, m1, (n / 2)); //m1 = (a11 + a22) (b11 + b22)

		matrix_sum(a21, a22, temp1, (n / 2));  // temp1 = a21 + a22
		matrix_mul(temp1, b11, m2, (n / 2));   //m2 = (a21 + a22) b11

		matrix_sub(b12, b22, temp1, (n / 2));  // temp1 = b12 - b22
		matrix_mul(a11, temp1, m3, (n / 2));   //m3 = a11 (b12 - b22)

		matrix_sub(b21, b11, temp1, (n / 2));  // temp1 = b21 - b11
		matrix_mul(a22, temp1, m4, (n / 2));   //m4 = a22 (b21 - b11)

		matrix_sum(a11, a12, temp1, (n / 2));  //temp1 = a11 + a12
		matrix_mul(temp1, b22, m5, (n / 2));   //m5 = (a11 + a12) b22

		matrix_sub(a21, a11, temp1, (n / 2));  // temp1 = a21 - a11
		matrix_sum(b11, b12, temp2, (n / 2));  // temp2 = b11 + b12
		matrix_mul(temp1, temp2, m6, (n / 2)); //m6 = (a21 - a11) (b11 + b12)

		matrix_sub(a12, a22, temp1, (n / 2));  // temp1 = a12 - a22
		matrix_sum(b21, b22, temp2, (n / 2));  // temp2 = b21 + b22
		matrix_mul(temp1, temp2, m7, (n / 2)); //m7 = (a12 - a22) (b21 + b22)


		//	calculation of resultant sub matrices values 
...
int display_sq_matrix(int **a,int n)
{
	int i,j;
	for (i = 0; i < n; i++) 
	{
...
int main()
{
    ...
    printf("\nEnter the dimension of square matrices\n");
    scanf("%d",&MAX);
   ...
   // MAX = atoi(argv[1]);
    ...
    printf("\nMatrix A\n");
	display_sq_matrix(a,MAX);
 

    printf("\nMatrix B\n");
    display_sq_matrix(b,MAX);
